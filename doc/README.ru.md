...
<p align="center"><a href="https://f-droid.org/packages/ac.mdiq.vista/"><img src="https://fdroid.gitlab.io/artwork/badge/get-it-on-en.svg" alt="Скачать на F-Droid" height=80/></a></p>
...
<a href="https://github.com/XilinJia/VoiVista/actions" alt="Состояние сборки"><img src="https://github.com/XilinJia/VoiVista/workflows/CI/badge.svg?branch=dev&event=push"></a>
<a href="https://hosted.weblate.org/engage/voivista/" alt="Состояние перевода"><img src="https://hosted.weblate.org/widgets/voivista/-/svg-badge.svg"></a>
<a href="https://web.libera.chat/#voivista" alt="Канал IRC: #voivista"><img src="https://img.shields.io/badge/IRC%20chat-%23voivista-brightgreen.svg"></a>
</p>
<hr>
...
<p align="center"><a href="https://github.com/XilinJia/VoiVista">Сайт</a> &bull; <a href="https://github.com/XilinJia/VoiVista/blog/">Блог</a> &bull; <a href="https://github.com/XilinJia/VoiVista/FAQ/">ЧЗВ</a> &bull; <a href="https://github.com/XilinJia/VoiVista/press/">Пресса</a></p>
<hr>
...
<b>РАЗМЕЩЕНИЕ VOIVISTA ИЛИ ЕГО ОТВЕТВЛЕНИЙ В МАГАЗИНЕ GOOGLE PLAY НАРУШАЕТ ИХ УСЛОВИЯ И ПОЛОЖЕНИЯ.</b>
...
VoiVista на данный момент поддерживает эти сервисы:
...
Как видите, VoiVista поддерживает несколько видео- и аудиосервисов. Хотя все началось с YouTube, с годами люди добавляли новые сервисы, делая VoiVista все более и более универсальным!
...
Если вы хотите добавить новый сервис, сначала свяжитесь с нами! В нашей [документации](https://XilinJia.github.io/documentation/) содержится дополнительная информация о том, как можно добавить новый сервис в приложение и в [VoiVista Extractor](https://github.com/XilinJia/VoiVistaGuide).

## Описание

VoiVista работает, извлекая необходимые данные из официального API (например, PeerTube) сервиса, который вы используете. Если официальный API ограничен (например, YouTube) для наших целей или является проприетарным, приложение анализирует веб-сайт или использует вместо этого внутренний API. Это означает, что вам не нужна учетная запись в этих сервисах для использования VoiVista.

Кроме того, поскольку это бесплатное и открытое программное обеспечение, ни приложение, ни Extractor не используют какие-либо проприетарные библиотеки или платформы, такие как Google Play Services. Это означает, что вы можете использовать VoiVista на устройствах или пользовательских ROM, на которых не установлены приложения Google.
...
Вы можете установить VoiVista одним из следующих способов:
 1. Добавьте наш пользовательский репозиторий в F-Droid и установите его оттуда. Инструкции находятся здесь: https://github.com/XilinJia/VoiVista/FAQ/tutorials/install-add-fdroid-repo/
 2. Скачайте APK из [GitHub Releases](https://github.com/XilinJia/VoiVista/releases) и установите его.
...
<img src="https://hosted.weblate.org/widgets/voivista/-/287x66-grey.png" alt="Состояние перевода">
</a>

## Пожертвование
Если вам нравится VoiVista, вы можете отправить пожертвование. Мы предпочитаем Liberapay, так как это открытая и некоммерческая платформа. Для получения дополнительной информации о пожертвовании VoiVista посетите наш [сайт](https://github.com/XilinJia/VoiVista/donate).
...
<table>
  <tr>
    ...
    <td><a href="https://liberapay.com/XilinJia/"><img src="assets/liberapay_qr_code.png" alt="Посетите VoiVista на liberapay.com" width="100px"></a></td>
    <td><a href="https://liberapay.com/XilinJia/donate"><img src="assets/liberapay_donate_button.svg" alt="Пожертвование через Liberapay" height="35px"></a></td>
  </tr>
</table>

## Политика конфиденциальности

Целью проекта VoiVista является предоставление конфиденциального анонимного доступа к мультимедийным веб-сервисам. Поэтому приложение не собирает никаких данных без вашего согласия. Политика конфиденциальности VoiVista подробно объясняет, какие данные отправляются и сохраняются, когда вы отправляете отчёт о сбое или оставляете комментарий в нашем блоге. Вы можете найти документ [здесь](https://github.com/XilinJia/VoiVista/legal/privacy/).

## Лицензия
[![Изображение GNU GPLv3](https://www.gnu.org/graphics/gplv3-127x51.png)](https://www.gnu.org/licenses/gpl-3.0.ru.html)

VoiVista — это бесплатное программное обеспечение: вы можете использовать, изучать, делиться и улучшать его по своему усмотрению. В частности, вы можете распространять и/или изменять ее в соответствии с условиями [Стандартной общественной лицензии GNU](https://www.gnu.org/licenses/gpl.html) (GPL-3.0), опубликованной Free Software Foundation, либо версии 3 Лицензии или (на ваш выбор) любая более поздняя версия.
