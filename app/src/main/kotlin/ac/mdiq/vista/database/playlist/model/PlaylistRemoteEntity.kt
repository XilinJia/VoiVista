package ac.mdiq.vista.database.playlist.model
...
class PlaylistRemoteEntity(serviceId: Int, name: String, url: String,
    ...
    fun isIdenticalTo(info: PlaylistInfo): Boolean {
        ...
        return (serviceId == info.serviceId && streamCount == info.streamCount && name == info.name
                && url == info.url && thumbnailUrl == imageListToDbUrl(info.thumbnails)
