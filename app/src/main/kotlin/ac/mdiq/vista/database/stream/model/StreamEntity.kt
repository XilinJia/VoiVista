package ac.mdiq.vista.database.stream.model
...
import ac.mdiq.vista.database.stream.model.StreamEntity.Companion.STREAM_SERVICE_ID
import ac.mdiq.vista.database.stream.model.StreamEntity.Companion.STREAM_TABLE
import ac.mdiq.vista.database.stream.model.StreamEntity.Companion.STREAM_URL
...
data class StreamEntity(
    ...
    var isUploadDateApproximation: Boolean? = null, ) : Serializable {
    ...
    constructor(info: StreamInfo) : this(
        ...
        duration = info.duration, uploader = info.uploaderName,
