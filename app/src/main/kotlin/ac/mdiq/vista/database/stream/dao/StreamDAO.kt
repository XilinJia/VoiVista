package ac.mdiq.vista.database.stream.dao
...
import ac.mdiq.vista.database.stream.model.StreamEntity.Companion.STREAM_ID
...
abstract class StreamDAO : BasicDAO<StreamEntity> {
    ...
    private fun compareAndUpdateStream(newerStream: StreamEntity) {
        ...
        if (!StreamTypeUtil.isLiveStream(newerStream.streamType)) {
            ...
            val hasBetterPrecision = newerStream.uploadDate != null && newerStream.isUploadDateApproximation != true
            ...
            if (existentMinimalStream.duration > 0 && newerStream.duration < 0) newerStream.duration = existentMinimalStream.duration
        }
    }
