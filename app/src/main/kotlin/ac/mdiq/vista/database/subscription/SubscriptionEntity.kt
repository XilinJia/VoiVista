...
import ac.mdiq.vista.util.image.ImageStrategy.dbUrlToImageList
...
class SubscriptionEntity {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (if (avatarUrl != null) avatarUrl != that.avatarUrl else that.avatarUrl != null) return false
        if (if (subscriberCount != null) subscriberCount != that.subscriberCount else that.subscriberCount != null) return false
