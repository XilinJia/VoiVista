...
import ac.mdiq.vista.databinding.FragmentMainBinding
...
import ac.mdiq.vista.ui.util.TabsManager.Companion.getManager
...
class MainFragment : BaseFragment(), OnTabSelectedListener {
  ...
  {@link androidx.viewpager2.adapter.FragmentStateAdapter} instead.""")
    abstract class FragmentStatePagerAdapterMenuWorkaround(private val mFragmentManager: FragmentManager, @param:Behavior private val mBehavior: Int)
        ...
        private val mSavedState = ArrayList<SavedState?>()
      ...
      {@link #BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT}""")
        ...
        override fun restoreState(state: Parcelable?, loader: ClassLoader?) {
            if (state != null) {
                ...
                val states = BundleCompat.getParcelableArrayList(bundle, "states", SavedState::class.java)
                mSavedState.clear()
                mFragments.clear()
