 ...
 * SuperScrollLayoutManager.kt is part of Vista.
 *
...
class SuperScrollLayoutManager(context: Context?) : LinearLayoutManager(context) {
    ...
    override fun onInterceptFocusSearch(focused: View, direction: Int): View? {
        ...
        if (listDirection == 0) return super.onInterceptFocusSearch(focused, direction)
        ...
        if (sourcePosition == 0 && listDirection < 0) return super.onInterceptFocusSearch(focused, direction)
