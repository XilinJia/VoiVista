 ...
 * FocusAwareDrawerLayout.kt is part of Vista.
 *
...
import ac.mdiq.vista.util.DeviceUtils.isConfirmKey
...
class FocusAwareSeekBar : AppCompatSeekBar {
    ...
    override fun onKeyDown(keyCode: Int, event: KeyEvent): Boolean {
        if (!isInTouchMode && isConfirmKey(keyCode)) releaseTrack()
        return super.onKeyDown(keyCode, event)
    }

    override fun onFocusChanged(gainFocus: Boolean, direction: Int, previouslyFocusedRect: Rect?) {
        super.onFocusChanged(gainFocus, direction, previouslyFocusedRect)
        if (!isInTouchMode && !gainFocus) releaseTrack()
    ...
    override fun onDetachedFromWindow() {
        if (treeObserver == null || !treeObserver!!.isAlive) treeObserver = viewTreeObserver
    ...
    private fun releaseTrack() {
        if (listener != null && listener!!.isSeeking) listener!!.onStopTrackingTouch(this)
    }
