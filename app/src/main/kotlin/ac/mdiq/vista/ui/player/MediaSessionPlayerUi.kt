...
import ac.mdiq.vista.player.notification.NotificationActionData.Companion.fromNotificationActionEnum
...
//    }
    ...
    private fun updateShouldIgnoreHardwareMediaButtons(sharedPreferences: SharedPreferences) {
...
//    }
    ...
    override fun onBroadcastReceived(intent: Intent?) {
        ...
        if (ACTION_RECREATE_NOTIFICATION == intent!!.action) updateMediaSessionActions()
    }
