...
import ac.mdiq.vista.player.notification.NotificationActionData
import ac.mdiq.vista.player.notification.NotificationConstants
import ac.mdiq.vista.player.notification.NotificationConstants.ACTION_RECREATE_NOTIFICATION
import ac.mdiq.vista.util.Logd
import ac.mdiq.vista.ui.util.NavigationHelper.getPlayQueueActivityIntent
...
//            .setStyle(mediaStyle)
        ...
        fun shouldUpdateBufferingSlot(): Boolean {
            return when {
                ...
                else -> ((notificationSlots[1] == NotificationConstants.PLAY_PAUSE_BUFFERING
        ...
        fun createNotificationAndStartForeground() {
            ...
            else playerManager.service.startForeground(NOTIFICATION_ID, notificationBuilder!!.build())
        }
        ...
        private fun initializeNotificationSlots(): IntArray {
            val settingsCompactSlots =
                NotificationConstants.getCompactSlotsFromPreferences(playerManager.context, playerManager.prefs)
            ...
            return adjustedCompactSlots.stream().mapToInt { obj: Int -> obj }.toArray()
        }
