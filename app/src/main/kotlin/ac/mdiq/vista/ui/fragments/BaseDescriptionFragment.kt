...
import ac.mdiq.vista.databinding.FragmentDescriptionBinding
import ac.mdiq.vista.databinding.ItemMetadataBinding
import ac.mdiq.vista.databinding.ItemMetadataTagsBinding
...
import ac.mdiq.vista.ui.util.TextLinkifier.fromPlainText
...
abstract class BaseDescriptionFragment : BaseFragment() {
    ...
    private fun setupDescription() {
        ...
        if (description == null || description.content.isEmpty() || description === Description.EMPTY_DESCRIPTION) {
