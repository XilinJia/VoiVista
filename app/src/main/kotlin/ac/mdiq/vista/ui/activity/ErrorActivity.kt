...
import ac.mdiq.vista.databinding.ActivityErrorBinding
...
* ErrorActivity.kt is part of Vista.
*
...
class ErrorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityErrorBinding!!.errorReportEmailButton.setOnClickListener {
    ...
    private fun openPrivacyPolicyDialog(context: Context, action: String) {
        AlertDialog.Builder(context)
            ...
            .setPositiveButton(R.string.accept) { _: DialogInterface?, _: Int ->
                ...
                } else if (action == "GITHUB") { // open the Vista issue page on GitHub
    ...
    companion object {
        ...
        const val ERROR_EMAIL_ADDRESS: String = "crashreport@voivista.schabi.org"
        const val ERROR_EMAIL_SUBJECT: String = "Exception in "

        const val ERROR_GITHUB_ISSUE_URL: String = "https://github.com/XilinJia/VoiVista/issues"
