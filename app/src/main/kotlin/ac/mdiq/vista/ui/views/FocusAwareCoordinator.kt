 ...
 * FocusAwareCoordinator.kt is part of Vista.
 *
...
class FocusAwareCoordinator : CoordinatorLayout {
    ...
    override fun requestChildFocus(child: View, focused: View) {
        ...
        if (!isInTouchMode) {
            if (focused.height >= height) {
                ...
                (child as ViewGroup).offsetDescendantRectToMyCoords(focused.parent as View, childFocus)
            }
    ...
    override fun dispatchApplyWindowInsets(insets: WindowInsets): WindowInsets {
        ...
        for (i in 0 until childCount) {
            ...
            if (res.isConsumed) consumed = true
        }
