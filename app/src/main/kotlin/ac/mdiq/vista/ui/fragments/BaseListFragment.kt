...
import ac.mdiq.vista.ui.views.SuperScrollLayoutManager
import java.util.*
...
abstract class BaseListFragment<I, N> : BaseStateFragment<I>(), ListViewContract<I, N>, WriteRead, OnSharedPreferenceChangeListener {
    @JvmField
    protected var savedState: ac.mdiq.vista.util.SavedState? = null
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        if (useDefaultStateSaving) savedState = tryToSave(requireActivity().isChangingConfigurations, savedState, outState, this)
    }

    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        super.onRestoreInstanceState(savedInstanceState)
        if (useDefaultStateSaving) savedState = tryToRestore(savedInstanceState, this)
    }
