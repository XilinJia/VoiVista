...
import ac.mdiq.vista.databinding.PlayerFastSeekSecondsViewBinding
...
class SecondsView(context: Context, attrs: AttributeSet?) : LinearLayout(context, attrs) {
    ...
    fun startAnimation() {
        ...
        if (animationsEnabled) firstAnimator.start()
        else showWithoutAnimation()
    }
