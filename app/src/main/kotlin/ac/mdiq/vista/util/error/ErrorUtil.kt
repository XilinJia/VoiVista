...
import ac.mdiq.vista.ui.activity.ErrorActivity
...
class ErrorUtil {
    companion object {
        ...
        fun showSnackbar(fragment: Fragment, errorInfo: ErrorInfo) {
            ...
            if (rootView == null && fragment.activity != null) rootView = fragment.requireActivity().findViewById(R.id.content)
...
//            }
            ...
            if (rootView == null) createNotification(context, errorInfo)
            else {
                try {
