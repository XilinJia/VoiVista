 ...
 * SubscriptionsExportService.kt is part of Vista
 *
 * License: GPL-3.0+
...
import ac.mdiq.vista.local.subscription.services.ImportExportJsonHelper.writeTo
        ...
        get() = object : Subscriber<StoredFileHelper> {
            ...
            override fun onComplete() {
                LocalBroadcastManager.getInstance(this@SubscriptionsExportService)
                    .sendBroadcast(Intent(EXPORT_COMPLETE_ACTION).setPackage(packageName))
