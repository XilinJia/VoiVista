...
@UnstableApi class NotificationActionData(
    ...
    companion object {
        ...
        fun fromNotificationActionEnum(playerManager: PlayerManager, @NotificationConstants.Action selectedAction: Int): NotificationActionData? {
            ...
            when (selectedAction) {
                NotificationConstants.Action.PREVIOUS -> return NotificationActionData(NotificationConstants.ACTION_PLAY_PREVIOUS, ctx.getString(R.string.exo_controls_previous_description), baseActionIcon)
                ...
                NotificationConstants.Action.REPEAT -> return when (playerManager.repeatMode) {
                    ...
                    androidx.media3.common.Player.REPEAT_MODE_ONE -> NotificationActionData(NotificationConstants.ACTION_REPEAT, ctx.getString(R.string.exo_controls_repeat_one_description), R.drawable.exo_styled_controls_repeat_one)
                    /* player.getRepeatMode() == REPEAT_MODE_OFF */
                    else -> NotificationActionData(NotificationConstants.ACTION_REPEAT, ctx.getString(R.string.exo_controls_repeat_off_description), R.drawable.exo_styled_controls_repeat_off)
                }
