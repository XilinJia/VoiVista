...
import ac.mdiq.vista.util.ListHelper.isMeteredNetwork
...
@UnstableApi object PlayerHelper {
    ...
    fun resizeTypeOf(context: Context, resizeMode: @AspectRatioFrameLayout.ResizeMode Int): String {
        return when (resizeMode) {
            ...
            AspectRatioFrameLayout.RESIZE_MODE_FIXED_HEIGHT, AspectRatioFrameLayout.RESIZE_MODE_FIXED_WIDTH ->
                throw IllegalArgumentException("Unrecognized resize mode: $resizeMode")
    ...
    fun autoQueueOf(info: StreamInfo, existingItems: List<PlayQueueItem>): PlayQueue? {
        ...
        for (item in relatedItems) {
            if (item is StreamInfoItem && !urls.contains(item.url)) autoQueueItems.add(item)
        }
    ...
    fun retrieveResizeModeFromPrefs(playerManager: ac.mdiq.vista.player.PlayerManager): @AspectRatioFrameLayout.ResizeMode Int {
    ...
    @SuppressLint("SwitchIntDef") // only fit, fill and zoom are supported by Vista
    fun nextResizeModeAndSaveToPrefs(playerManager: ac.mdiq.vista.player.PlayerManager, resizeMode: @AspectRatioFrameLayout.ResizeMode Int): @AspectRatioFrameLayout.ResizeMode Int {
    ...
    fun retrievePlaybackParametersFromPrefs(playerManager: ac.mdiq.vista.player.PlayerManager): PlaybackParameters {
    ...
    fun savePlaybackParametersToPrefs(playerManager: ac.mdiq.vista.player.PlayerManager, speed: Float, pitch: Float, skipSilence: Boolean) {
    ...
    fun retrieveSeekDurationFromPreferences(playerManager: ac.mdiq.vista.player.PlayerManager): Int {
