...
import ac.mdiq.vista.util.ListHelper.getAudioTrackComparator
...
import ac.mdiq.vista.util.ListHelper.getVideoStreamIndex
import java.util.*
...
class ListHelperTest {
    val sortedStreamVideosListTest: Unit
        get() {
            ...
            for (i in result.indices) {
                ...
                Assert.assertEquals(expected[i], result[i].resolution)
            }
    ...
    val sortedStreamVideosListWithPreferVideoOnlyStreamsTest: Unit
        get() {
            ...
            for (i in result.indices) {
                Assert.assertEquals(expected[i], result[i].resolution)
                Assert.assertEquals(expectedVideoOnly.contains(result[i].resolution),
